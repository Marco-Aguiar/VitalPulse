...
import med.vitalpulse.api.domain.consulta.Consulta;
import med.vitalpulse.api.domain.endereco.DadosEndereco;
import med.vitalpulse.api.domain.paciente.DadosCadastroPaciente;
...
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioLivreNaDataCenario1() {
        ...
        var proximaSegundaAs10 = LocalDate.now()
                ...
                .atTime(10, 0);
        var medico = cadastrarMedico("Medico", "medico@vitalpulse.med", "123456", Especialidade.CARDIOLOGISTA);
